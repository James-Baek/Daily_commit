...
module.exports.findBookNum = function(bookName){
  var bookList = [ "창세기",
              "출애굽기",
              "레위기",
              "민수기",
  ...
  if(typeof bookName == "undefined" || bookName == null || bookName == ""){
    ...
    index = bookList.indexOf(bookName.trim());
  }

  return index;
}
module.exports.getBookByNum = function (index) {
  var urlList = [
...
module.exports.searchBook = function(book) {
  var index = this.findBookNum(book);
